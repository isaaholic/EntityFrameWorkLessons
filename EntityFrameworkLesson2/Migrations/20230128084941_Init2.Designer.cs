...
namespace EntityFrameworkLesson2.Migrations
{
    ...
    [Migration("20230128084941_Init2")]
    partial class Init2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EntityFrameworkLesson2.Models.Student", b =>
                {
                    ...
                    b.HasOne("EntityFrameworkLesson2.Models.S_Card", "S_Card")
                        .WithOne("Student")
                        .HasForeignKey("EntityFrameworkLesson2.Models.Student", "S_CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
